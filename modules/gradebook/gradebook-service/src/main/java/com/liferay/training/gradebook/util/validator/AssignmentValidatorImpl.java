...
public class AssignmentValidatorImpl implements AssignmentValidator {
    ...
    /**
     * Validates assignment values and throws {AssignmentValidationExceptionException} if the assign ment values are not valid.
     *
     * @param titleMap
    ...
    public void validate(
            Map<Locale, String> titleMap, Map<Locale, String> descriptionMap, Date dueDate) throws AssignmentValidationException {
    ...
    /**
     * Returns <code>true</code> if the given fields are vali d for an assignment.
     *
     * @param titleMap
     * @param descriptionMap
     * @param dueDate
    ...
    private boolean isAssignmentValid(
            final Map<Locale, String> titleMap, final Map<Locale, String> descriptionMap, final Date dueDate, final List<String> errors) {
        boolean result = true;
    ...
    /**
     * Returns <code>true</code> if description is valid for  an assignment.
     * If not valid, an error message is added to the errors list
     *
     * @param descriptionMap
     * @param errors
    ...
    /**
     * Returns <code>true</code> if due date is valid for an assignment.
     * If not valid, an error message is added to the errors list.
