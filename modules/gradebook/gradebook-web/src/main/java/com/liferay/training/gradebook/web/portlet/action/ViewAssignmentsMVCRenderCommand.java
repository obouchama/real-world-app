...
public class ViewAssignmentsMVCRenderCommand implements MVCRenderCommand {
    ...
    /**
     * Adds assignments list related attributes to the request.**
     *
     * @param renderRequest: the renderRequest parameter.
     */
    private void addAssignmentListAttributes(RenderRequest renderRequest) {
        ...
        // Get sorting options.
        // Notice that this doesn't really sort on title because the field is stored in XML.
        // In real world this search would be integrated to the search engine to get localized sort options.
        ...
        OrderByComparator<Assignment> comparator =
                OrderByComparatorFactoryUtil.create("Assignment", orderByCol, !("asc").equals(orderByType));
        ...
        List<Assignment> assignments =
                _assignmentService.getAssignmentsByKeywords(themeDisplay.getScopeGroupId(), keywords, start, end, comparator);
     ...
     *
     * @param renderRequest: the renderRequest parameter.
     * @param renderResponse: the renderResponse parameter.
     */
